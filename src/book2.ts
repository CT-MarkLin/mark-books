...
　　罗尔斯的正义理论，一言以蔽之，可称作正义即公平的理论。得出这个理论的各项原则，首先需要说明一个前提，这就是社会契约是如何产生的。这里就必须做一个理性上或逻辑上的假设。罗尔斯把这个假设环境称作“原始状态”（originalpo-sition），相当于自然状态在卢梭、洛克等人思想体系中的地位。
...
　　罗尔斯的《正义即公平》一文发表于1958年，《正义论》一书成于1971年。这些年间，正是美国社会风云变幻的年代。资本主义社会固有的矛盾和冲突接踵而至，此起彼伏。经济危机、通货膨胀、种族歧视、民权运动、女权运动、贫困问题、抵制越战的浪潮、学生造反……接连发生。这无疑会引起人们对社会正义问题的反思。罗尔斯置身于这样一个时代，认真思考和观察这些现象，并把走出困境的希望寄托于正义观念的澄清。这自然是一个过份学究气的想法，但他作了可观的努力。必须指出，罗尔斯仅仅是一个改良主义者，他的目的是在资本主义的现有范围内进行改良，而不是去改变它。

　　罗尔斯的主要目的在于通过用正义即公平的观念来取代功利主义的正义观念，从而推动社会变化。他的注意力集中在民权和贫困两大问题上。这两大问题在美国社会长期以来没有得到解决，这是由资本主义社会的基本结构所决定的。他提出的自由权优先，考虑最少受惠者的利益，平等自由等观念，也都是为这些难题寻找出路。正像罗尔斯所表示的那样，政治生活中依然存在着我行我素的权势集团，经济生活中依然存在着巨大的分配鸿沟，徘徊于街头车站的无家可归的人依然构成对制度的最大挑战，黑人的社会地位依然令人担忧……这些问题的存在也构成《正义论》一书走红的社会条件。只要这些问题存在，解决这些问题的讨论就不会结束。
...
　　正义理论可以分为两大部分：（l）解释原始状态和提出可在原始状态中用来进行选择的各种原则，（2）论证事实上可能＿采用哪些原则。本章将讨论适用于体制的两个正义原则和适用于个人的几个原则，并说明这些原则的含义。因此，目前我所关心的只是这个理论的第一部分的一个方面。要到下一章我才着手解释原始状态问题，并开始提出论据说明这里所考虑的原则事实上会得到承认。要讨论的各种问题有：作为正义主题的体制和形式正义的概念；三种程序正义；关于善的理论的地位；正义原则就是平等主义原则的观念以及其他观念。每一个讨论的目的都是要说明这些原则的含义及其运用问题。
